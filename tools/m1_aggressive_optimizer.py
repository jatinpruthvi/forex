...
LONDON_PAIRS = ["EURUSD", "GBPUSD", "EURGBP", "EURJPY", "GBPJPY"]
NY_PAIRS = ["AUDUSD", "NZDUSD", "USDCAD", "USDCHF", "USDJPY", "XAUUSD"]
SPECS = {
    "EURUSD": {"pip": 0.0001, "pv": 10.0},
    "GBPUSD": {"pip": 0.0001, "pv": 10.0},
    "EURGBP": {"pip": 0.0001, "pv": 12.7},
    "AUDUSD": {"pip": 0.0001, "pv": 10.0},
    "NZDUSD": {"pip": 0.0001, "pv": 10.0},
    "USDCAD": {"pip": 0.0001, "pv": 9.8},
    "USDCHF": {"pip": 0.0001, "pv": 9.8},
    "USDJPY": {"pip": 0.01,   "pv": 6.76},
    "EURJPY": {"pip": 0.01,   "pv": 6.13},
    "GBPJPY": {"pip": 0.01,   "pv": 5.18},
    "XAUUSD": {"pip": 0.1,    "pv": 10.0},
}
